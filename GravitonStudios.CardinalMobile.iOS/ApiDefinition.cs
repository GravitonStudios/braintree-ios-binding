...
namespace CardinalMobile
{
	...
	interface CardinalSession
	{
		...
		// -(void)processBin:(NSString * _Nonnull)accountNumber didComplete:(CardinalSessionProcessBinDidCompleteHandler _Nullable)didCompleteHandler __attribute__((swift_name("processBin(_:completed:)")));
		...
		// -(void)continueWithTransactionId:(NSString * _Nonnull)transactionId payload:(NSString * _Nonnull)payload acsUrl:(NSString * _Nonnull)acsUrl directoryServerID:(CCADirectoryServerID)directoryServerID didValidateDelegate:(id<CardinalValidationDelegate> _Nonnull)validationDelegate __attribute__((swift_name("continueWith(transactionId:payload:acsUrl:directoryServerID:validationDelegate:)"))) __attribute__((deprecated("")));
		[Export("continueWithTransactionId:payload:acsUrl:directoryServerID:didValidateDelegate:")]
		void ContinueWithTransactionId(string transactionId, string payload, string acsUrl, CCADirectoryServerID directoryServerID, CardinalValidationDelegate validationDelegate);

		// -(void)continueWithTransactionId:(NSString * _Nonnull)transactionId payload:(NSString * _Nonnull)payload directoryServerID:(CCADirectoryServerID)directoryServerID didValidateDelegate:(id<CardinalValidationDelegate> _Nonnull)validationDelegate __attribute__((swift_name("continueWith(transactionId:payload:directoryServerID:validationDelegate:)"))) __attribute__((deprecated("")));
		[Export("continueWithTransactionId:payload:directoryServerID:didValidateDelegate:")]
		void ContinueWithTransactionId(string transactionId, string payload, CCADirectoryServerID directoryServerID, CardinalValidationDelegate validationDelegate);
		...
		void ContinueWithTransactionId(string transactionId, string payload, CardinalValidationDelegate validationDelegate);
	...
	[Static]
	partial interface CardinalSessionConstants
	{
		...
		NSString RenderTypeSingleSelect { get; }
		...
		NSString RenderTypeMultiSelect { get; }
	...
	interface CardinalSessionConfiguration : INSCopying
	{
		...
		// @property (assign, nonatomic) NSUInteger timeout __attribute__((deprecated("")));
		[Export("timeout")]
	...
	interface AuthenticationRequestParameters
	{
		...
		//[NullAllowed, Export("getDeviceData")]
	...
	interface CompletionEvent
	{
		...
		//// -(NSString * _Nonnull)getTransactionStatus;
	...
	interface ProtocolErrorEvent
	{
		...
		//// -(ErrorMessage * _Nonnull)getErrorMessage;
		//[Export("getErrorMessage")]
		//[Verify(MethodToProperty)]
		//ErrorMessage ErrorMessage { get; }
...
*/
	...
	interface ChallengeParameters
	{
		...
		//[Export("get3DSServerTransactionID")]
		//[Verify(MethodToProperty)]
		//string Get3DSServerTransactionID { get; }
		...
		//[Verify(MethodToProperty)]
		//string ThreeDSRequestorAppURL { get; }
	}
	...
	interface Transaction
	{
		...
		bool DoChallengeWithChallengeParameters(ChallengeParameters challengeParameters, ChallengeStatusReceiver challengeStatusReceiver, int timeOut, [NullAllowed] out NSError error);
