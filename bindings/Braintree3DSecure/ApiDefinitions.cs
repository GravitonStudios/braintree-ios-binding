...
namespace Braintree3DSecure
{
	...
	interface BTThreeDSecureCardNonce
	{
		...
		// -(instancetype _Nonnull)initWithNonce:(NSString * _Nonnull)nonce description:(NSString * _Nullable)description cardNetwork:(BTCardNetwork)cardNetwork lastTwo:(NSString * _Nullable)lastTwo threeDSecureJSON:(BTJSON * _Nonnull)threeDSecureJSON isDefault:(BOOL)isDefault cardJSON:(BTJSON * _Nonnull)cardJSON;
		[Export ("initWithNonce:description:cardNetwork:lastTwo:threeDSecureJSON:isDefault:cardJSON:")]
